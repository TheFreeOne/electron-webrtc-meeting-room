...
ipcRenderer.on(ChannelConstant_1.default.CREATE_MEETING_WINDOW_SUCCESS, (event, _roomNumber, _actionType) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(ChannelConstant_1.default.CREATE_MEETING_WINDOW_SUCCESS);
    //@ts-ignore
